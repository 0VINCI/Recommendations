...
public static class Extensions
{
    public static IServiceCollection AddQueries(this IServiceCollection services)
    {
        ...
        services.AddScoped<IQueryHandler<GetProductsByIds, IReadOnlyCollection<ProductDto>>, GetProductsByIdsHandler>();
        services.AddScoped<IQueryHandler<GetProductsByIdsForRecommendations, IReadOnlyCollection<ProductDto>>, GetProductsByIdsForRecommendationsHandler>();
