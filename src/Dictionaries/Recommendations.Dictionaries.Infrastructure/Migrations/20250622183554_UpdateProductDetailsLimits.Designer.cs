...
namespace Recommendations.Dictionaries.Infrastructure.Migrations
{
    ...
    [Migration("20250622183554_UpdateProductDetailsLimits")]
    partial class UpdateProductDetailsLimits
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Recommendations.Dictionaries.Core.Types.Product", b =>
                {
                    ...
                    b.HasOne("Recommendations.Dictionaries.Core.Types.BaseColour", null)
                        .WithMany("Products")
                        .HasForeignKey("BaseColourId1");
